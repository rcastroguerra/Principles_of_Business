...
<img
  src="./img/001.jpg" 
  width="800" 
  alt="Bowl de comida saludable con quinoa, garbanzos tostados, pechuga de pollo en rodajas, aguacate en láminas, zanahorias asadas, brócoli, hojas verdes, brotes frescos y semillas, presentado en un plato blanco visto desde arriba.">
...
**Place**
<img src="./img/003.jpg" width="800"></img>
...
<img
  src="./img/003.jpg" 
  width="800"
  alt="Ilustración de un mapa urbano plegado sobre un fondo amarillo, que muestra calles, parques y cuerpos de agua. El mapa incluye varios marcadores de ubicación de distintos colores que señalan diferentes puntos de interés dentro de la ciudad, sugiriendo localización, distribución geográfica o selección de lugares clave.">
...
<img src="./img/004.jpg" width="800" alt="Paisaje urbano diurno con un sendero peatonal rodeado de césped, un puente sobre un río y un conjunto de edificios altos al fondo, incluyendo una torre art déco, bajo un cielo azul con nubes y árboles con colores otoñales.">
...
<img src="./img/005.jpg" width="800" alt="Escena diurna en un campus urbano con un grupo numeroso de personas caminando por una acera amplia frente a un edificio moderno con grandes ventanales, árboles con colores otoñales y una motocicleta detenida a un lado del camino.">
...
<img src="./img/006.jpg" width="800" alt="Mercado al aire libre sobre césped con mesas llenas de utensilios domésticos y objetos usados, vehículos y remolques alrededor, varias personas revisando los artículos y cielo despejado en un día soleado.">
...
<img src="./img/002.jpg" width="800" alt="Ilustración vectorial de un megáfono blanco y gris dentro de un círculo turquesa, con líneas que representan sonido, asociada a anuncios, promoción y comunicación.">
...
<img src="./img/007.jpg" width="800"
     alt="Primer plano de manos usando una computadora portátil con iconos digitales superpuestos que muestran métricas de interacción en línea, como corazones, mensajes, seguidores y notificaciones, representando actividad en redes sociales y comunicación digital">
...
<img src="./img/008.jpg" width="800" alt="Camión de comida blanco estacionado frente a una pared de ladrillos, con ventana lateral abierta y equipos de cocina visibles en su interior, representando un negocio móvil de venta de alimentos">
...
<img src="./img/009.jpg" width="800" alt="Varios buzones de correo blancos alineados sobre postes junto a una calle residencial, con casas al fondo ligeramente desenfocadas y luz cálida de atardecer, representando un entorno suburbano y distribución local.">
...
<img src="./img/010.jpg" width="800" alt="Ilustración de un bowl de ensalada visto desde arriba, con hojas verdes, rodajas de pepino, tomates cherry, aceitunas negras y crutones, en un plato amarillo de estilo gráfico y minimalista.">
...
<img src="./img/001.jpg" width="800" alt="Bowl de comida saludable visto desde arriba con quinoa, garbanzos tostados, pechuga de pollo en rodajas, hojas verdes, zanahorias asadas, aguacate en rebanadas, semillas y brotes frescos, presentado en un recipiente blanco."></img>
...
<img src="./img/011.jpg" width="800" alt="Ilustración de dos billetes verdes con símbolo de dólar, superpuestos dentro de un círculo naranja, que representan dinero, pagos o precios en un contexto de negocios o marketing">
