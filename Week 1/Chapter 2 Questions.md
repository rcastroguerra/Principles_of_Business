...
flowchart LR
    subgraph Stages
        S1[1. Financial & Economic Viability]
        S2[2. Legal & Regulatory Compliance]
        S3[3. Ethics, Principles & Values]
        S4[4. Philanthropic Activities]
    end

    subgraph Examples
        E1[Starbucks offers investors a healthy return on investment, including paying dividends. ]
        E2[Starbucks specifies in its code of conduct that payments made to foreign government officials must be lawful according to the laws of the United States and the foreign country.]
        E3[Starbucks offers healthcare benefits to part-time employees and supports coffee growers by offering them fair prices.]
        E4[Starbucks created the Starbucks Foundation to award grants to eligible nonprofits and to give back to its communities.]
    end
...
flowchart LR
    ...
    subgraph Descriptions
        D1[A. usually the result of smoke and other pollutants emitted by manufacturing facilities]
        D2[B. Chemical compounds reacting with air and rain]
    end
